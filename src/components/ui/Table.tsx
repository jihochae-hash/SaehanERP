...
export default function Table<T extends Record<string, any>>({
  ...
  const handleExport = () => {
    ...
    exportToExcel(exportCols, sortedData as Record<string, unknown>[], (typeof exportFileName === 'string' ? exportFileName : undefined) ?? 'export')
  }

  return (
    <div>
      {exportFileName !== false && sortedData.length > 0 && (
